      ...
      <Container>
        ...
        <div className="d-content-news text-textLight dark:text-textDark2nd">
          ...
          >
            ...
            cho Seven Teen dưới hình thức qua yêu cầu từ Trang Web&nbsp;
            <a
              href={url}
              style={{
                color: "#0563c1",
            ...
            phòng. Seven Teen sẽ xác nhận đặt phòng/ dịch vụ được gửi qua email
          ...
          >
            ...
            sửa chữa Khách Sạn v.v...), Seven Teen có quyền di dời Khách sang
            loại phòng/ Khách Sạn khác có tiêu chuẩn tương đương loại phòng/
            Khách Sạn mà Khách hàng/ Đối tác đã đặt và được Seven Teen xác nhận.
          </p>
          ...
          <ul>
            ...
            >
              Nếu Khách hàng/ Đối tác không cung cấp thông tin đúng hạn, Seven
              Teen có quyền hủy đặt phòng khỏi hệ thống, từ chối áp dụng giá ưu
              đãi theo Voucher, xác nhận Yêu Cầu Dịch Vụ, thỏa thuận, hợp đồng
              đã ký kết giữa Khách hàng/ Đối tác và Seven Teen. Trong trường hợp
              đó, Seven Teen sẽ áp dụng Giá Công Bố tại Khách Sạn vào ngày Khách
              làm thủ tục nhận phòng nếu còn phòng trống, và Đối Tác sẽ chịu
              hoàn toàn trách nhiệm giải quyết các khiếu nại của Khách phát sinh
              do việc cung cấp thông tin muộn.
            </li>
            <li
              style={{
                marginTop: "6pt",
