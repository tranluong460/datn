...
const Search = () => {
  ...
  const durationLabel = useMemo(() => {
    if (params.get("checkin") && params.get("checkout")) {
      const start = moment(params.get("checkin")).format("DD/MM/YYYY");
      const end = moment(params.get("checkout")).format("DD/MM/YYYY");
        ...
        <div className="font-sans bg-white mx-auto w-full max-w-[650px] px-5 md:px-8 lg:px-8 rounded-[3px]">
          <div className="flex flex-row space-x-4">
            ...
            <div className="relative mt-[48px] ml-[15px] ">
              <button className="relative pl-8 pr-2 text-sm text-white bg-amber-400 w-ful py-3 border-gray-300 rounded transition-all duration-300 focus:outline-none focus:border-yellow-500 hover:border-yellow-500">
                Tìm kiếm
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
