        ...
        <div className="font-sans bg-white mx-auto w-full max-w-6xl px-5 md:px-8 lg:px-8 rounded-[3px]">
          <div className="flex flex-row space-x-4">
            ...
            <div className="relative my-[20px] ml-[15px] basis-1/2">
              ...
              <div className="relative">
                <input
                  className="pl-8 pr-2 text-sm  text-sm bg-neutral-200 w-full text-gray-500 py-3 border border-gray-300 rounded transition-all duration-300 focus:outline-none focus:border-yellow-500 hover:border-yellow-500"
                  type=""
                  value={durationLabel}
                  onClick={searchModal.onOpen}
                />
